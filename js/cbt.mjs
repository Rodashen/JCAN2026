...
function renderSetup(){
  ...
  const intro=el('section',{},el('p',{class:'eyebrow'},UBT?'EPS-TOPIK · UBT tablet practice':'EPS-TOPIK · Computer-based practice'),el('h1',{},'Get ready for your Korean language test.'),el('p',{class:'lead'},'Practice with Korean questions, picture choices and recorded listening in a focused exam workspace.'),el('div',{class:'facts'},el('div',{},el('strong',{},'40'),el('span',{},'Questions')),el('div',{},el('strong',{},'50'),el('span',{},'Minutes')),el('div',{},el('strong',{},'2'),el('span',{},'Sections'))),el('ol',{class:'steps'},el('li',{},'Reading: 20 questions in 25 minutes.'),el('li',{},'Listening: 20 questions in 25 minutes.'),el('li',{},'In the full exam, recordings play in sequence, twice per question.'),el('li',{},'Review your answers and results after submitting.')),el('p',{class:'source-note'},'Random tests from '+pool.questions.length+' questions. Each retry prefers questions absent from your previous test. ',el('a',{href:bank.source,target:'_blank',rel:'noopener'},'Source: My EPS-TOPIK Exam'),'. These are practice materials, not a live official exam.'));
  intro.append(el('p',{class:'source-note'},'Additional reading questions: © HRD Korea, ',el('a',{href:'https://epstopik.hrdkorea.or.kr/epstopik/book/std/standardBookList.do?lang=en',target:'_blank',rel:'noopener'},'2024 NEW Standard Korean Textbook 2'),'. Source pages and answer keys are credited in answer review.'));
